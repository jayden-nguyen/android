...
<script>
    ...
    $(document).ready(function () {
       ...
       $("#search").on("click",function () {
          username_search =  $("#user-text").val();
          getData(page,username_search)
       });
       ...
       function getData(page,username_search) {
           $("#table-body").empty();
           $.ajax({
               url:"page.php",
               data:{page:page,username_search:username_search},
               dataType:"json",
               ...
               success:function (output) {
                   ...
                   for(var i = 0;i<output.length;i++){
                       ...
                       $("#table-body").append(
                           '<tr>'
                           +'<td>'+ output[i].user_id+'</td>'
                           +'<td>'+ output[i].user_name+'</td>'
                           +'<td>'+output[i].full_name+'</td>'
                           +'<td>' + output[i].email +'</td>'
                           +'<td>' + output[i].age +'</td>'
                           +'<td>' + output[i].birth +'</td>'
                           +'<td>' + output[i].gender +'</td>'
                           +'<td>'+ '<a href="edit_user.php?id_edit='+output[i].user_id+'">edit  </a>'
                           +'<a href="home.php?id_delete='+output[i].user_id+'">     delete</a>'+'</td>'
                       )
