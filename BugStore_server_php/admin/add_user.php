...
if(isset($_POST['btn-submit'])){
    ...
    $insert_sql = "INSERT INTO user(user_name,full_name,email,gender,password) VALUES ('$user_name','$full_name','$email','$gender','$password')";
...
<div id="main">
    ...
    <form action="add_user.php" method="post">
        ...
        <div class="form-group">
            ...
            <input type = "password" id = "age" placeholder="age" class="form-control" name="password"/>
        </div>
